                ...
                <div className="py-30 px-30">
                  <div>
                    ...
                    <div className="col-xl-6">
                      <p className="mt-15">
                        Keep it short! Type or Record your answer! Record with
                        the audio or video buttons above! From your readings,
                        define Digital Literacy in no more than 15 words. Can
                        you master the art of being succinct?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="d-flex x-gap-30 justify-center items-center mt-30">
                    <div>
