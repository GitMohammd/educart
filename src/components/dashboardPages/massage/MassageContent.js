                  ...
                  <div className="y-gap-30">
                    <div className="d-flex justify-between">
                      ...
                      <div className="d-flex items-end flex-column pt-8">
                        <div className="text-13 lh-1">35 mins</div>
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-between">
                      ...
                      <div className="d-flex items-end flex-column pt-8">
                        ...
                        <div className="d-flex justify-center items-center size-20 bg-blue-3 rounded-full mt-8">
                    ...
                    <div className="d-flex justify-between">
                      ...
                      <div className="d-flex items-end flex-column pt-8">
                        ...
                        <div className="d-flex justify-center items-center size-20 bg-yellow-4 rounded-full mt-8">
                          <span className="text-11 lh-1 text-white fw-500">
                            3
                          </span>
                        </div>
                  ...
                  <div className="row y-gap-20">
                    ...
                    <div className="col-xl-7 offset-xl-5 col-lg-10 offset-lg-2">
                      <div className="d-flex items-center justify-end">
                        ...
                        <div className="lh-11 fw-500 text-dark-1 mr-10">
                          You
                        </div>
                        <div className="shrink-0">
                          <img
