              ...
              <div className="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                ...
                <div className="py-30 px-30">
                    ...
                    <div className="px-30 py-30 border-top-light">
                      ...
                      <div className="row y-gap-20 justify-between items-center pt-30">
                        <div className="col-auto">
                          <a
                            href="#"
                            className="text-purple-1 fw-500 underline"
                          >
                            + Add condition
                          </a>
                        </div>
                  ...
                  <div className="d-flex x-gap-10 y-gap-10 flex-wrap pt-20">
                    ...
                    <div>
                      <div className="size-35 d-flex justify-center items-center border-light rounded-4 bg-dark-1 text-white -dark-text-dark-1">
                        J
                      </div>
                    </div>
                  ...
                  <div className="mt-40">
                    ...
                    <div className="px-30 border-bottom-light">
                      <div className="row x-gap-10 items-center py-15">
                        ...
                        <div className="col-lg-2">Student</div>
                        <div className="col-lg-2">Team South</div>
                        <div className="col-lg-3">1 year 31 days</div>
                      </div>
                    </div>
