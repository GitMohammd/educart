...
import Home9TopCatagories from "../home9/Home9TopCatagories";
import LetestBook from "../home9/LetestBook";
                  ...
                  <div class="col-xl-7 col-lg-6">
                    <div class="masthead__content">
                      ...
                      >
                        ...
                        <br class="lg:d-none" /> professional trainers for free
                      </p>
                        ...
                        <div class="masthead-form bg-white rounded-16 mt-30 px-10 py-10">
                          <form class=" d-flex x-gap-30 y-gap-10 items-center flex-wrap">
                            ...
                            <div class="masthead-form__button">
                              <button class="button -dark-1 text-white -dark-button-dark-1">
                                Search
                              </button>
                            </div>
                          </form>
                      ...
                      <div data-anim-child="slide-up delay-6">
                        <div class="text-white mt-20">
                          Trending Search: Development, Business, Design,
                          Merketing
                        </div>
                      </div>
                    </div>
                ...
                <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
                  <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="d-flex flex-column items-center text-center">
                      ...
                      <div class="text-17 fw-500 text-dark-1 mt-30">
                ...
                <div class="row justify-center text-center pt-60 lg:pt-40">
                  <div class="col-auto">
                    <p class="lh-1">
                      ...
                      <a class="text-purple-1 underline" href="#">
                ...
                <div class="row items-center justify-between">
                  ...
                  <div class="col-auto">
                    <div class="d-flex items-center">
                      ...
                      <button class="button -md -rounded bg-light-4 text-light-1 ml-30">
                        English
                      </button>
                    </div>
                  </div>
