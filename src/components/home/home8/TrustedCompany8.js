...
function TrustedCompany8() {
  return (
    <section className="layout-pt-md layout-pb-md bg-light-6">
      <div data-anim-wrap className="container">
        ...
        <div className="row y-gap-30 justify-between sm:justify-start items-center pt-60 md:pt-50">
          <div
            ...
            className="col-lg-auto col-md-2 col-sm-3 col-6"
          >
...
export default TrustedCompany8;
