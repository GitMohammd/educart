        ...
        <div className="row pt-60 lg:pt-40">
          <div className="col-auto">
            <div className="d-flex x-gap-15 justify-center items-center">
              <div className="col-auto">
                <button className="d-flex items-center text-24 arrow-left-hover js-students-slider-prev">
              ...
              <div className="col-auto">
                <button className="d-flex items-center text-24 arrow-right-hover js-students-slider-next">
