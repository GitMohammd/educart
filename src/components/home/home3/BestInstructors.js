          ...
          <div data-anim-wrap className="container">
            ...
            <div className="row y-gap-30 pt-50">
              ...
              <div className="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" className="teamCard -type-1 -teamCard-hover">
              ...
              <div className="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-3" className="teamCard -type-1 -teamCard-hover">
                  <div className="teamCard__image">
              ...
              <div className="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-4" className="teamCard -type-1 -teamCard-hover">
                  <div className="teamCard__image">
              ...
              <div className="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-5" className="teamCard -type-1 -teamCard-hover">
                  <div className="teamCard__image">
            ...
            <div className="row justify-center text-center pt-60 lg:pt-40">
              <div className="col-auto">
                <p className="lh-1">Want to help people learn, grow and achieve more in life? <a className="text-purple-1 underline" href="#">Become an instructor</a></p>
              </div>
            </div>
          </div>
        </section>
