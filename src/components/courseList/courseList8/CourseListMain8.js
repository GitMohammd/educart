...
function CourseListMain8() {
  return (
    <section className="layout-pt-md layout-pb-lg">
          <div data-anim="slide-up delay-3" className="container">
            ...
            <div className="row y-gap-30 justify-center">
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/1.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">Learn Figma - UI/UX Design Essential Training</div>
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/2.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">Complete Python Bootcamp From Zero to Hero in Python</div>
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/3.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">Angular - The Complete Guide (2022 Edition)</div>
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/4.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">The Ultimate Drawing Course Beginner to Advanced</div>
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/5.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">Photography Masterclass: A Complete Guide to Photography</div>
              ...
              <div className="col-lg-6">
                <a href="#" className="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                  <div className="coursesCard__image max-w-250">
                    <img className="w-1/1 rounded-8" src="assets/img/coursesCards/6.png" alt="image" />
                  </div>
                  ...
                  <div className="coursesCard__content pl-20 sm:pl-10 pr-10">
                    ...
                    <div className="text-17 lh-13 fw-500 text-dark-1 mt-10">Complete Blender Creator: Learn 3D Modelling for Beginners</div>
...
export default CourseListMain8