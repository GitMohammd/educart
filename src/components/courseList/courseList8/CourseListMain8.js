...
import CourseListFilter8 from "./CourseListFilter8";
import KeyboardArrowUpIcon from "@mui/icons-material/KeyboardArrowUp";
import KeyboardArrowDownIcon from "@mui/icons-material/KeyboardArrowDown";
import FilterCourseList8 from "./FilterCourseList8";
import Pagination from "../courseList1/Pagination";

function CourseListMain8(props) {
  const catRef = useRef();
      ...
      <div data-anim="slide-up delay-3" className="container">
        ...
        <div className="row y-gap-30 justify-center">
          {currentCourse?.map((course) => {
            return <FilterCourseList8 key={course.id} course={course} />;
          })}
        </div>
