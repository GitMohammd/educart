...
function CourseListMain5() {
  return (
    <section className="layout-pt-md layout-pb-lg">
      <div data-anim-wrap className="container">
        <div data-anim="slide-up delay-1" className="accordion js-accordion">
        ...
        <div className="row y-gap-30">
          ...
          <div data-anim-child="slide-up delay-5" className="col-lg-4 col-md-6">
            <a
              href="courses-single-1.html"
              className="coursesCard -type-1 rounded-8 bg-white shadow-3"
            >
          ...
          <div data-anim-child="slide-up delay-6" className="col-lg-4 col-md-6">
            <a
              href="courses-single-1.html"
              className="coursesCard -type-1 rounded-8 bg-white shadow-3"
            >
          ...
          <div data-anim-child="slide-up delay-7" className="col-lg-4 col-md-6">
            <a
              href="courses-single-1.html"
              className="coursesCard -type-1 rounded-8 bg-white shadow-3"
            >
          ...
          <div data-anim-child="slide-up delay-8" className="col-lg-4 col-md-6">
            <a
              href="courses-single-1.html"
              className="coursesCard -type-1 rounded-8 bg-white shadow-3"
            >
          ...
          <div data-anim-child="slide-up delay-9" className="col-lg-4 col-md-6">
            <a
              href="courses-single-1.html"
              className="coursesCard -type-1 rounded-8 bg-white shadow-3"
            >
...
export default CourseListMain5;
